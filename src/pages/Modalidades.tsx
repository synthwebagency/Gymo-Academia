...
const Modalidades: React.FC = () => {
  const modalities = [
    ...
    },
    {
      ...
      price: 'Consultar Planos',
      icon: <Target />,
      image: '/images/basquetebol-mod.jpg',
      link: '/basquetebol',
    ...
    },
    {
      ...
      price: 'Ver Planos Específicos',
      icon: <Zap />,
      image: '/images/musculacao-mod.jpg',
      link: '/musculacao',
